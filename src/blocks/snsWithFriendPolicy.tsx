...
export const snsWithFriendPolicyComponent: ComponentDef<SnsWithFriendPolicyValue> = {
  ...
  CardItem({ value, ctx, variant, blockConfig }) {
    ...
    if (isGlass) {
      ...
      return (
        <div style={{ width: '100%', background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(255,255,255,0.75)', borderRadius: ctx.cardWidth * 0.006, boxShadow: '0 0 12px rgba(0,0,0,0.08)', padding: '4px 8px', display: 'flex', flexDirection: 'column' }}>
