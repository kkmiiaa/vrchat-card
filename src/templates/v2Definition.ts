      ...
      children: [
        ...
        { type: 'block', componentKey: 'divider', dataKey: 'divider', variant: 'vertical' },
        {
          ...
          children: [
              ...
              children: [
                {
                  ...
                  minH: 2.3,
                  children: [
                    { type: 'ref', blockId: 'gender',   surface: 'glass', minH: 2.3 },
                    { type: 'ref', blockId: 'age',      surface: 'glass', minH: 2.3, labelInset: true, labelInsetDir: 'row', contentFontScale: 0.9, labelColor: '#9ca3af' },
            ...
            { type: 'ref', blockId: 'selfIntro', flex: 1, surface: 'glass', contentFontScale: 0.8 },
            {
              type: 'row',
              gap: 3,
              minH: 11,
