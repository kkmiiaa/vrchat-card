...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'authenticated',
      testMatch: /\/(authenticated|regression-card-editor|regression-card-save|regression-card-view|regression-profile|explore-search|spec-header|spec-draft|spec-card-flow|spec-settings-auth|spec-explore|spec-legacy-maker|ogp-image|upgrade)\.spec\.ts/,
      dependencies: ['setup'],
      use: {
